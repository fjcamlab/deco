...
# 4. SDA, Recursive Differential Analysis: *Standard.Chi.Square*
...
This vignette presented some examples of `decoSDA()` subsampling function for *supervised* and *unsupervised* analyses (if user has two classes of samples or not). Now, details about all the input parameters which control the SDA procedure are indicated:
