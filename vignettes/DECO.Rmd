...
sub_multiclass <- decoRDA(
    ...
    r = NULL, iterations = 1000, annot = FALSE, rm.xy = FALSE,
    id.type = "ENSEMBL", pack.db = "org.Hs.eg.db"
)
```
...
- `pack.db` is a character corresponding to the annotation library (by default `org.Hs.eg.db`).
